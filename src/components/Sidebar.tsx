    ...
    >
      ...
      <div className="p-4 border-t border-[#2A211A] bg-[#0C0A08] space-y-3">
        ...
        <a
          ...
          rel="noreferrer"
          translate="no"
          className="notranslate w-full flex items-center justify-center gap-2 py-2 text-xs text-[#1DA851] hover:opacity-80 transition-all font-semibold cursor-pointer"
        >
